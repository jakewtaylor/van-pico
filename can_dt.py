class CANMessager:
    ...
    def parse_can_message(self, message: tuple[int, int, int, int, int, int, int, int]):
...
print(f"0x331a === {0x331a}")
print(f"0x3301 === {0x3301}")
print(f"0x15a4 === {0x15a4}")

can_messager = CANMessager()

message = can_messager.build_can_message(0x331a, 1378)
print("CAN message, id: 0x331a, value: 1378", message)
print("Parsed message: ", can_messager.parse_can_message(message))

# message2 = can_messager.build_can_message(0x3301, -50)
# print("CAN message 2, id: 0x3301, value: -50", message2)
# print("Parsed message: ", can_messager.parse_can_message(message2))

message3 = can_messager.build_can_message(0x15a4, True)
print("CAN message 3, id: 0x15a4, value: True", message3)
print("Parsed message: ", can_messager.parse_can_message(message3))